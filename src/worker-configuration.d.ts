/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 27e0e7d6d26a73623248e5bff8c17097)
// Runtime types generated with workerd@1.20260916.1 2026-09-17 
interface __BaseEnv_Env {
	REQUIRE_SIGNATURE: "true";
	CATALOGUE: DurableObjectNamespace<import("./worker").CatalogueObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "CatalogueObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REQUIRE_SIGNATURE">> {}
}
